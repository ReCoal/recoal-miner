...
template<>
inline constexpr size_t cn_select_memory<cryptonight_recoal>() { return CRYPTONIGHT_MEMORY; }
...
template<>
inline constexpr uint32_t cn_select_mask<cryptonight_recoal>() { return CRYPTONIGHT_MASK; }
...
template<>
inline constexpr uint32_t cn_select_iter<cryptonight_recoal>() { return CRYPTONIGHT_ITER; }
